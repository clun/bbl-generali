...
import com.mycompany.myapp.DemoAppBBlApp;
 ...
 */
@SpringBootTest(classes = DemoAppBBlApp.class)
...
public class RegionResourceIT {
    ...
    private static final String DEFAULT_GENERAL_CODE = "AAAAAAAAAA";
    private static final String UPDATED_GENERAL_CODE = "BBBBBBBBBB";
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region()
            ...
            .generalCode(DEFAULT_GENERAL_CODE);
        return region;
    }
    /**
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region()
            ...
            .generalCode(UPDATED_GENERAL_CODE);
        return region;
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getGeneralCode()).isEqualTo(DEFAULT_GENERAL_CODE);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].generalCode").value(hasItem(DEFAULT_GENERAL_CODE)));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.generalCode").value(DEFAULT_GENERAL_CODE));
    }
    @Test
    @Transactional
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getGeneralCode()).isEqualTo(UPDATED_GENERAL_CODE);
    }
